const sections = [
    ...
    },
    {
        ...
        content: `
            ...
            <ul>
                <li><strong>Authoritarianism:</strong> The rise of governments that suppress individual freedoms.</li>
                <li><strong>Populism:</strong> Movements that may challenge democratic norms.</li>
                <li><strong>Technological Change:</strong> Issues around data privacy and surveillance.</li>
            </ul>
            <h3>Your Role</h3>
            <p>Think about how you can contribute to upholding liberal values:</p>
            <ul>
                <li><strong>Civic Engagement:</strong> Participate in the democratic process.</li>
                <li><strong>Advocacy:</strong> Stand up for the rights of others.</li>
                <li><strong>Continuous Learning:</strong> Stay informed about social and political issues.</li>
            </ul>
            <p>By understanding the foundations of Liberalism, you are better equipped to navigate and influence the world around you.</p>
        `
    },
    {
